        ...
        public static class Modes
        {
            ...
            public static class Combo
            {
                ...
                static Combo()
                {
                    ...
                    _useW = ModesMenu.Add("comboW", new CheckBox("Use Smart W", false));
                    _useE = ModesMenu.Add("comboE", new CheckBox("Use E"));
                    _useR = ModesMenu.Add("comboR", new CheckBox("Use R"));
                    _manaR = ModesMenu.Add("manaR", new Slider("Min mana to use R", 20));
                }
            ...
            public static class Harass
            {
                ...
                static Harass()
                {
                    ...
                    _manaR = ModesMenu.Add("harassmanaR", new Slider("Min Mana to use R", 40));
                }
